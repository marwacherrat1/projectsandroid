        ...
        barreRecherche.addTextChangedListener(new TextWatcher() {
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (query.toString().isEmpty()) {
                    ...
                    MyAdapteradd myAdapter = new MyAdapteradd(contacts, com.example.contactapp.noshop.this);
                    ...
                    MyAdapteradd myAdapter = new MyAdapteradd(filteredContacts, com.example.contactapp.noshop.this);
                    contactsRecycler.setAdapter(myAdapter);
                }
            }
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            contactsRecycler.setAdapter(myAdapter);
                            LinearLayoutManager layoutManager = new LinearLayoutManager(com.example.contactapp.noshop.this);
