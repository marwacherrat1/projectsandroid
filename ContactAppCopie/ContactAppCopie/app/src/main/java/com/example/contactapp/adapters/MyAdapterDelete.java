...
public class MyAdapterDelete extends RecyclerView.Adapter<com.example.contactapp.adapters.MyAdapterDelete.MyViewHolder>{
    ...
    public MyAdapterDelete.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.contact_item_layout_delete,
                        parent, false);
        MyAdapterDelete.MyViewHolder vh = new MyAdapterDelete.MyViewHolder(itemLayoutView);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(MyAdapterDelete.MyViewHolder holder, int position) {
